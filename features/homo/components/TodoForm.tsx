...
interface TodoFormProps {
  /** Called after a successful submission — use to navigate away */
  onSuccess?: () => void;
}
  ...
  return (
    <div className="w-full max-w-2xl">
      ...
      <div className="mb-8">
        ...
        <h2 className="text-2xl font-bold tracking-tight">Create a Todo</h2>
      </div>
              ...
              <FormItem>
                ...
                <FormControl>
                  <Textarea
                    ...
                    className="resize-none min-h-[88px] bg-muted/40 border-transparent focus:border-foreground/20 focus:bg-background transition-all"
                    {...field}
                  />
                </FormControl>
                <FormMessage className="text-xs" />
